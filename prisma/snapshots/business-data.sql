...
\restrict 2GQVpJTizTiWBLvbFU0s9awxfdUDVL0LyDoifjRdgZJc4tHTWFoahiW2nvwVKZ8
...
INSERT INTO public.rooms (id, name, description, capacity, "pricePerNight", "isActive", "createdAt", "updatedAt", "photoUrl", status, type) VALUES (5, 'La Abuela', 'Ambiente íntimo.', 4, 150.00, false, '2026-08-28 17:46:30.268', '2026-08-28 17:46:30.268', '/uploads/images-1787599149834-33111325.jpg', 'inactive', 'FAMILIAR');
...
INSERT INTO public.reservations (id, "roomId", "customerId", "checkIn", "checkOut", "totalPrice", status, "createdAt", "updatedAt", guests, message, "preferredTime") VALUES (13, 1, 19, '2026-08-26 00:00:00', '2026-08-27 00:00:00', 120.00, 'CANCELADA', '2026-08-25 19:24:55', '2026-08-28 18:30:23.633', NULL, NULL, NULL);
...
INSERT INTO public.reservations (id, "roomId", "customerId", "checkIn", "checkOut", "totalPrice", status, "createdAt", "updatedAt", guests, message, "preferredTime") VALUES (48, 5, 14, '2026-08-28 00:00:00', '2026-09-01 00:00:00', 600.00, 'CANCELADA', '2026-08-27 16:44:41', '2026-08-28 18:30:23.633', '6+ personas', NULL, '00:00');
...
INSERT INTO public.reservations (id, "roomId", "customerId", "checkIn", "checkOut", "totalPrice", status, "createdAt", "updatedAt", guests, message, "preferredTime") VALUES (56, 2, 19, '2026-08-29 00:00:00', '2026-08-30 00:00:00', 180.00, 'CANCELADA', '2026-08-28 15:20:00', '2026-08-28 18:30:23.633', '1 persona', NULL, '00:00');
...
\unrestrict 2GQVpJTizTiWBLvbFU0s9awxfdUDVL0LyDoifjRdgZJc4tHTWFoahiW2nvwVKZ8
